                                        ...
                                        <tbody>
                                            @forelse ($rutas as $ruta)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('rutas.updateStatus', $ruta->id) }}" method="POST" style="display: inline;">
                                                            @csrf
                                                            @method('PATCH')
                                                            <button type="submit" class="btn btn-sm {{ $ruta->is_realizada ? 'btn-success' : 'btn-warning' }}">
                                                                {{ $ruta->is_realizada ? 'Marcada como Realizada' : 'Marcar como Realizada' }}
                                                            </button>
                                                        </form>
                                                    </td>
                                                </tr>
