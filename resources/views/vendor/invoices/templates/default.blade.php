...
<html lang="en">
    ...
    <body>
        ...
        <table class="table table-items">
            <thead>
                <tr>
                    <th scope="col" class="border-0 pl-0">{{ __('Descripcion') }}</th>
                    @if($invoice->hasItemUnits)
                        <th scope="col" class="text-center border-0">{{ __('invoices::invoice.units') }}</th>
                    @endif
                    <th scope="col" class="text-center border-0">{{ __('Peso') }}</th>
                    <th scope="col" class="text-right border-0">{{ __('Precio') }}</th>
